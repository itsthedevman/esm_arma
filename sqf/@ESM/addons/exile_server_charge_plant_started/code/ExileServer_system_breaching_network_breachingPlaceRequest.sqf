...
try
{
	...
	if (!isNull _territory && {_serverTime > ((_territory getVariable ["ExileXM8MobileNotifiedTime",-1800]) + 1800)}) then
	{
		_territory call ExileServer_system_xm8_sendChargePlantStarted;
