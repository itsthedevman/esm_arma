...
private _redeemButton = _dialog displayCtrl IDC_ITEM_DIALOG_REDEEM_BUTTON;
private _quantityDropdown = _dialog displayCtrl IDC_ITEM_DIALOG_QUANTITY_DROPDOWN;
private _inventoryLoadLabel = _dialog displayCtrl IDC_ITEM_DIALOG_PLAYER_LOAD_LABEL;
...
private _tradingResult = TRADING_RESPONSE_OK;
